...
class Agent():
    ...
    def __init__(self, state_size, action_size, actor_lr, critic_lr, weight_decay, buffer_size, batch_size,
                 gamma, tau, device, random_seed):
        ...
        # Replay memory
        self.memory = ReplayBuffer(action_size, self.buffer_size, self.batch_size, self.device, random_seed)
